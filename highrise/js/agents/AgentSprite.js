...
export class AgentSprite {
    ...
    constructor(agentDef, options = {}) {
        ...
        this._moveSpeed = 1.5; // units/sec
        this._moveProgress = 0;
        this._moveOrigin = null;

        // Animation timers
        this._stateTime = 0;     // time in current state
        this._bobPhase = Math.random() * Math.PI * 2; // offset so agents don't sync
        ...
        this.group.userData = { type: 'agent', agentId: this.id, sprite: this };

        this._buildMeshes(agentDef);
        this._buildTrail();
        this._buildGlow(agentDef);
    ...
    _buildMeshes(agentDef) {
        ...
        const avatarColor = new THREE.Color(agentDef.avatar || '#888888');
